...
print("Running BTC/ADA pair trading backtest:")
...
portfolio = bt.backtest_mean_reversion("BTC/USDT", "ADA/USDT", START_DATE, END_DATE)
results = bt.analyze_results(portfolio, "BTC/USDT", "ADA/USDT")
...
print("\n" + "=" * 50)
print("COMPARISON WITH ETH/BTC")
print("=" * 50)
print("BTC/ADA correlation: 0.947 (very high)")
print("ETH/BTC correlation: 0.132 (very low)")
print("Higher correlation should lead to better pair trading results!")
