...
print("Running BTC/BNB pair trading backtest:")
...
portfolio = bt.backtest_mean_reversion("BTC/USDT", "BNB/USDT", START_DATE, END_DATE)
results = bt.analyze_results(portfolio, "BTC/USDT", "BNB/USDT")
...
print("Should perform similarly to BTC/ADA!")
