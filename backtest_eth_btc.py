...
print("Running ETH/BTC pair trading backtest:")
...
portfolio = bt.backtest_mean_reversion("ETH/USDT", "BTC/USDT", START_DATE, END_DATE)
results = bt.analyze_results(portfolio, "ETH/USDT", "BTC/USDT")
